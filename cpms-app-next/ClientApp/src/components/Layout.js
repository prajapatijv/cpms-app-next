                ...
                <div className="container d-flex flex-column flex-md-row justify-content-between">
                    <a className="py-2" href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            className="d-block mx-auto"><circle cx="12" cy="12" r="10"></circle>
                    ...
                    <a className="py-2 p-done d-md-inline-block" href="/">Design Group</a>
                </div>
            </nav>
        </header>
    <div className="container-fluid">
        <div className="row">
                <nav className="col-md-2 navbar navbar-expand-lg navbar-light bg-light">
                <NavMenu />
            </nav>
